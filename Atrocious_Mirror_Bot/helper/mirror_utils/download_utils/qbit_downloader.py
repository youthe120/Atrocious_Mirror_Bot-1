...
from Atrocious_Mirror_Bot import download_dict, download_dict_lock, BASE_URL, dispatcher, get_client, TORRENT_DIRECT_LIMIT, TAR_UNZIP_LIMIT
...
from Atrocious_Mirror_Bot.helper.ext_utils.bot_utils import setInterval, new_thread, MirrorStatus, getDownloadByGid, get_readable_file_size, check_limit
        ...
        try:
            ...
            if BASE_URL is not None and qbitsel:
                ...
                for n in str(self.ext_hash):
                    ...
                    if count == 4:
                        break
                URL = f"{BASE_URL}/Atrocious/files/{self.ext_hash}"
