...
from Atrocious_Mirror_Bot import parent_id, DOWNLOAD_DIR, IS_TEAM_DRIVE, INDEX_URL, \
...
from Atrocious_Mirror_Bot.helper.ext_utils.bot_utils import get_readable_file_size, setInterval
from Atrocious_Mirror_Bot.helper.ext_utils.fs_utils import get_mime_type, get_path_size
from Atrocious_Mirror_Bot.helper.ext_utils.shortenurl import short_url
...
class GoogleDriveHelper:
    ...
    def __upload_empty_file(self, path, file_name, mime_type, parent_id=None):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'Uploaded By Atrocious Mirror Bot',
            'mimeType': mime_type,
        }
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = 'Atrocious Mirror Search',
                                 author_name='Atrocious Mirror',
                                 author_url='https://t.me/Atrocious_Bot_Support',
