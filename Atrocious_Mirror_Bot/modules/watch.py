...
from Atrocious_Mirror_Bot import DOWNLOAD_DIR, dispatcher, LOGGER
from Atrocious_Mirror_Bot.helper.telegram_helper.message_utils import sendMessage, sendStatusMessage
from .mirror import MirrorListener
from Atrocious_Mirror_Bot.helper.mirror_utils.download_utils.youtube_dl_download_helper import YoutubeDLHelper
...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/LmBYPXGqtss 720 |Atrocious</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>Atrocious</b>"
